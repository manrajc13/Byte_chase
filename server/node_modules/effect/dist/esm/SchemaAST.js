 ...
 * @since 3.10.0
 */
export const annotations = (ast, a) => {
...
const getTemplateLiteralPattern = type => {
  switch (type._tag) {
    case "StringKeyword":
...
const getExpected = ast => {
  return getIdentifierAnnotation(ast).pipe(Option.orElse(() => getTitleAnnotation(ast)), Option.orElse(() => getDescriptionAnnotation(ast)), Option.orElse(() => getAutoTitleAnnotation(ast)));
};
