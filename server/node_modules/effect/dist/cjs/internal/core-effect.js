...
const tryPromise = arg => {
  ...
  if (evaluate.length >= 1) {
    return core.async((resolve, signal) => {
      try {
        evaluate(signal).then(a => resolve(core.exitSucceed(a)), e => resolve(catcher ? core.failSync(() => catcher(e)) : core.fail(new core.UnknownException(e))));
      } catch (e) {
  ...
  return core.async(resolve => {
    try {
      evaluate().then(a => resolve(core.exitSucceed(a)), e => resolve(catcher ? core.failSync(() => catcher(e)) : core.fail(new core.UnknownException(e))));
    } catch (e) {
      resolve(catcher ? core.failSync(() => catcher(e)) : core.fail(new core.UnknownException(e)));
    }
  });
