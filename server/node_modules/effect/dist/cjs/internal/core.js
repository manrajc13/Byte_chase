...
var _blockedRequests = _interopRequireWildcard(require("./blockedRequests.js"));
...
const gen = function () {
  ...
  return suspend(() => {
    ...
    effect.effect_instruction_i0 = f(_Function.pipe);
    return effect;
  });
};
/* @internal */
...
/** @internal */
const timeoutExceptionFromDuration = duration => new TimeoutException(`Operation timed out before the specified duration of '${Duration.format(duration)}' elapsed`);
/** @internal */
