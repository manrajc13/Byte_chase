...
import { FetchHttpClient, Headers as Headers$1, HttpApp, HttpServerResponse, HttpServerRequest, HttpRouter, HttpClient, HttpClientRequest, HttpClientResponse, HttpBody } from '@effect/platform';
...
const makeRuntime = (fetch, config)=>{
    ...
    const withRedactedHeaders = Layer.effectDiscard(FiberRef.update(Headers$1.currentRedactedNames, (_)=>_.concat([
...
const createRouteHandler = (opts)=>{
    ...
    return Router().all("/", // eslint-disable-next-line @typescript-eslint/no-misused-promises
    async (req, res)=>{
